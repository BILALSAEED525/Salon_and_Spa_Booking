    ...
    >
        ...
        <div style={{ display: "flex", gap: 4 }}>
          {TABS.map(({ key, label, icon }) => (
            <button
              ...
              style={{
                background:
                  activeTab === key ? "rgba(198,168,124,.15)" : "none",
                border: "none",
                borderBottom:
                  activeTab === key
                    ? "2px solid var(--gold)"
                ...
                color:
                  activeTab === key ? "var(--gold)" : "rgba(255,255,255,.55)",
                cursor: "pointer",
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        >
          ...
          <span className="bp-customer-view-label">Customer view</span>
        </button>
        ...
        >
          <i
            ...
            style={{ fontSize: 17, color: "rgba(255,255,255,.5)" }}
          />
        </button>
      </div>
    </nav>
